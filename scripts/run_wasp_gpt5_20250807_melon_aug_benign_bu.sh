...
OUT_ROOT="$ROOT/results/raw/wasp_gpt5_20250807_melon_aug_benign"
LOG_ROOT="$ROOT/results/logs/gpt5_20250807_melon_aug_benign"
...
# --------------------------------------------------
# MELON embedding -> DashScope
# --------------------------------------------------
source "$ROOT/.env.qwen"

export MELON_API_KEY="$OPENAI_API_KEY"
export MELON_BASE_URL="$OPENAI_API_BASE"
export MELON_EMBED_MODEL="text-embedding-v4"
export MELON_SIM_THRESHOLD="0.8"

# Remove Qwen/DashScope variables before loading main GPT.
...
export NO_PROXY="127.0.0.1,localhost,10.176.60.153,172.17.0.1,dashscope.aliyuncs.com"
...
print()
print("==========================================")
print(f"GPT-5-2025-08-07 MELON-Aug BENIGN TOTAL: {score:.0f}/{tasks:.0f}")
