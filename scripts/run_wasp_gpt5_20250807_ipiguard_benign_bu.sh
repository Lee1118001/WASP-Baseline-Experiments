...
OUT_ROOT="$ROOT/results/raw/wasp_gpt5_20250807_ipiguard_benign"
LOG_ROOT="$ROOT/results/logs/gpt5_20250807_ipiguard_benign"
...
# GPT uses official OpenAI endpoint through SOCKS.
unset OPENAI_BASE_URL || true
unset OPENAI_API_BASE || true
