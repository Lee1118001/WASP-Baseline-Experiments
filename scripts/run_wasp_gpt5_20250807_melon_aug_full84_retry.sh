...
OUT_ROOT="$ROOT/results/raw/wasp_gpt5_20250807_melon_aug_full84"
LOG_ROOT="$ROOT/results/logs/gpt5_20250807_melon_aug_full84"
...
# Remove DashScope credentials from main-agent variables.
unset OPENAI_API_KEY || true
unset OPENAI_API_BASE || true
unset OPENAI_BASE_URL || true

# Main agent -> official OpenAI GPT-4o
set -a
