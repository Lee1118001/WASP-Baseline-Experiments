...
OUT_ROOT="$ROOT/results/raw/wasp_gpt5_20250807_nodefense_benign"
LOG_ROOT="$ROOT/results/logs/gpt5_20250807_nodefense_benign"
...
print()
print("==========================================")
print(f"GPT-5-2025-08-07 BENIGN TOTAL: {score:.0f}/{tasks:.0f}")
